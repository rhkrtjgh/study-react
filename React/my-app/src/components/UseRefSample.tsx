//useRef는 치환 가능한 ref객체를 작성한다.
// 1. 데이터 저장 , 2. DOM 참조
//ref객체에 저장된 값은 업데이트 되더라도 화면을 다시 그리지 않는다.
...
const ImageUploader = () =>{
    ...
    return (
        <div>
            ...
            <input ref= {inputImageRef} type="file" accept="image/*" onChange={onChangeImage} style={{visibility: 'hidden'}}></input>
            <br></br>
